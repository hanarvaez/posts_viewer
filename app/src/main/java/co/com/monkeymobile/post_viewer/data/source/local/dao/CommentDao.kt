...
import co.com.monkeymobile.post_viewer.data.source.local.entities.COMMENT_ID_COLUMN_NAME
...
interface CommentDao {
    ...
    @Query("SELECT * FROM $COMMENT_TABLE_NAME WHERE $COMMENT_ID_COLUMN_NAME = :postId")
